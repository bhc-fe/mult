let exec = require('child_process').exec,
		...
		path = require('path');
//压缩包对应svn目录
const SVN_URL = 'https://code.ds.gome.com.cn/svn/gome_bh_jszx/30_Coding/NewDevMode/trunk/life/life-zip';
//svn用户名
const userName = "lijianbing";
//压缩包本地目录（写到压缩包目录的上一级）
const SVN_PATH = "E:\\gome_bh_jszx\\30_Coding\\NewDevMode\\trunk\\life";
//本地压缩包的父级文件名
const SVN_NAME =  "life-zip";
